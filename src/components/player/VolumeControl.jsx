 ...
 * Sliders for controlling bass and metronome volumes
 */
...
function VolumeControl({
  ...
  return (
    <div className="bg-[var(--color-primary-dark)]/60 rounded-xl p-3 sm:p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 min-w-[80px]">
            ...
            <span className="text-xs text-[var(--color-primary-light)]">Bajo</span>
          </div>
          <input
            type="range"
            min="0"
          ...
          />
          <span className="text-xs text-[var(--color-cream)] font-mono min-w-[36px] text-right">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 min-w-[80px]">
            ...
            <span className="text-xs text-[var(--color-primary-light)]">Metrón.</span>
          </div>
          <input
            type="range"
            min="0"
